...
// Web-based plugin installation is off unless MOODLE_ALLOW_WEB_PLUGIN_INSTALL is
// set, because the code tree is rebuilt from the image on every update. When it
// is on, moodle-plugin-sync copies installed plugins back to /config/plugins.
$out .= cfg('disableupdateautodeploy', !env_bool('MOODLE_ALLOW_WEB_PLUGIN_INSTALL'));
